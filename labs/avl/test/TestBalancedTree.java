 ...
 *
 */
public class TestBalancedTree2 {
	...
	@Test
	public void testHeightUpdateDelete() {
		AVLTree<Integer> tree = genTree().tree;
		tree.insert(5);
		int leafHeight = tree.getRoot().height;
		tree.insert(1);
		...
		tree.remove(10);
		assertEquals("Height of node {5} does not match leaf height", leafHeight, tree.getRoot().height);
	}
